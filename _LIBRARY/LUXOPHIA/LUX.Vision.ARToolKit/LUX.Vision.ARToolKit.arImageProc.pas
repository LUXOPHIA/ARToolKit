 ...
 *)
function arImageProcInit( const xsize_:T_int; const ysize_:T_int ) :P_ARImageProcInfo; stdcall; external _DLLNAME_;
...
(*!
    ...
    @see arImageProcInit
 *)
procedure arImageProcFinal( ipi_:P_ARImageProcInfo ); stdcall; external _DLLNAME_;
 ...
 *)
function arImageProcLumaHist( ipi_:P_ARImageProcInfo; const dataPtr_:P_ARUint8 ) :T_int; stdcall; external _DLLNAME_;
 ...
 *)
function arImageProcGetHistImage( ipi_:P_ARImageProcInfo ) :P_unsigned_char; stdcall; external _DLLNAME_;
...
(*!
    ...
    @result 0 in case of success, or a value less than 0 in case of error.
 *)
function arImageProcLumaHistAndCDF( ipi_:P_ARImageProcInfo; const dataPtr_:P_ARUint8 ) :T_int; stdcall; external _DLLNAME_;
...
(*!
    ...
    @result 0 in case of success, or a value less than 0 in case of error.
 *)
function arImageProcLumaHistAndCDFAndPercentile( ipi_:P_ARImageProcInfo; const dataPtr_:P_ARUint8; const percentile_:T_float; value_p_:P_unsigned_char ) :T_int; stdcall; external _DLLNAME_;
...
(*!
    ...
    @result 0 in case of success, or a value less than 0 in case of error.
 *)
function arImageProcLumaHistAndCDFAndMedian( ipi_:P_ARImageProcInfo; const dataPtr_:P_ARUint8; value_p_:P_unsigned_char ) :T_int; stdcall; external _DLLNAME_;
...
(*!
    ...
    @result 0 in case of success, or a value less than 0 in case of error.
 *)
function arImageProcLumaHistAndOtsu( ipi_:P_ARImageProcInfo; const dataPtr_:P_ARUint8; value_p_:P_unsigned_char ) :T_int; stdcall; external _DLLNAME_;
 ...
 *)
{$IF not AR_DISABLE_THRESH_MODE_AUTO_ADAPTIVE }
function arImageProcLumaHistAndBoxFilterWithBias( ipi_:P_ARImageProcInfo; const dataPtr_:P_ARUint8; const boxSize_:T_int; const bias_:T_int ) :T_int; stdcall; external _DLLNAME_;
{$ENDIF}
...
(*!
    ...
    @result 0 in case of success, or a value less than 0 in case of error.
 *)
function arImageProcLumaHistAndCDFAndLevels( ipi_:P_ARImageProcInfo; const dataPtr_:P_ARUint8 ) :T_int; stdcall; external _DLLNAME_;
